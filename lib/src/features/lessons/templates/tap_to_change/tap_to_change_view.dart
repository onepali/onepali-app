...
import 'package:onepali/src/features/lessons/templates/tap_to_change/tap_to_change_bloc/tap_to_change_bloc.dart';
...
class TapToChangeView extends StatefulWidget {
  const TapToChangeView({super.key, required this.content});
