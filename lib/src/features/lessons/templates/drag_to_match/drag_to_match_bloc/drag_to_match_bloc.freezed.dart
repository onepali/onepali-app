...
mixin _$DragToMatchState {
 ...
 List<ItemPosition> get itemPositions; List<ItemPosition> get outlinePositions; List<String> get matchedItemIds; int get currentHintIndex; bool get isPlayingHint; bool get isPlayingAudio; bool get showNepaliword; bool get showCat; bool get completionFeedbackReady; String? get currentPlayingAudioId; DragStatus get dragStatus; String? get draggedItemId; String? get targetOutlineId; String? get currentTargetItemId;
...
switch (_that) {
case _DragToMatchState() when $default != null:
return $default(_that.itemPositions,_that.outlinePositions,_that.matchedItemIds,_that.currentHintIndex,_that.isPlayingHint,_that.isPlayingAudio,_that.showNepaliword,_that.showCat,_that.completionFeedbackReady,_that.currentPlayingAudioId,_that.dragStatus,_that.draggedItemId,_that.targetOutlineId,_that.currentTargetItemId);case _:
  return orElse();
