...
- Type: `tap_to_reveal`
- View: `lib/src/features/lessons/views/tap_to_reveal_lesson_view.dart`
- Logic: `lib/src/features/lessons/blocs/tap_to_reveal_lesson_content_bloc/tap_to_reveal_lesson_content_bloc.dart`
