...
import 'package:onepali/src/features/lessons/templates/put_in_bag/put_in_bag_bloc/put_in_bag_bloc.dart';
...
class PutInBagView extends StatefulWidget {
  ...
  const PutInBagView({super.key, required this.content});
