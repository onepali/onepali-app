...
- View: `lib/src/features/lessons/views/listen_and_repeat_view.dart`
- Logic: `lib/src/features/lessons/blocs/listen_and_repeat_bloc/listen_and_repeat_bloc.dart`
