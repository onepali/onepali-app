...
mixin _$ChooseCorrectLessonContentState {
 ...
 ChooseCorrectLessonContent? get lessonContent; Item? get currentQuestion; bool get isQuestionAudioPlaying; bool get isQuestionAudioCompleted; Item? get selectedItem; bool get isCorrect; bool get isAnswered; bool get isAudioPlaying;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(lessonContent),currentQuestion,isQuestionAudioPlaying,isQuestionAudioCompleted,selectedItem,isCorrect,isAnswered,isAudioPlaying);

@override
String toString() {
  return 'ChooseCorrectLessonContentState(lessonContent: $lessonContent, currentQuestion: $currentQuestion, isQuestionAudioPlaying: $isQuestionAudioPlaying, isQuestionAudioCompleted: $isQuestionAudioCompleted, selectedItem: $selectedItem, isCorrect: $isCorrect, isAnswered: $isAnswered, isAudioPlaying: $isAudioPlaying)';
}
...
@useResult
$Res call({
 ChooseCorrectLessonContent? lessonContent, Item? currentQuestion, bool isQuestionAudioPlaying, bool isQuestionAudioCompleted, Item? selectedItem, bool isCorrect, bool isAnswered, bool isAudioPlaying
});
...
/// Create a copy of ChooseCorrectLessonContentState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? lessonContent = freezed,Object? currentQuestion = freezed,Object? isQuestionAudioPlaying = null,Object? isQuestionAudioCompleted = null,Object? selectedItem = freezed,Object? isCorrect = null,Object? isAnswered = null,Object? isAudioPlaying = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ChooseCorrectLessonContent? lessonContent,  Item? currentQuestion,  bool isQuestionAudioPlaying,  bool isQuestionAudioCompleted,  Item? selectedItem,  bool isCorrect,  bool isAnswered,  bool isAudioPlaying)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChooseCorrectLessonContentState() when $default != null:
return $default(_that.lessonContent,_that.currentQuestion,_that.isQuestionAudioPlaying,_that.isQuestionAudioCompleted,_that.selectedItem,_that.isCorrect,_that.isAnswered,_that.isAudioPlaying);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ChooseCorrectLessonContent? lessonContent,  Item? currentQuestion,  bool isQuestionAudioPlaying,  bool isQuestionAudioCompleted,  Item? selectedItem,  bool isCorrect,  bool isAnswered,  bool isAudioPlaying)  $default,) {final _that = this;
switch (_that) {
case _ChooseCorrectLessonContentState():
return $default(_that.lessonContent,_that.currentQuestion,_that.isQuestionAudioPlaying,_that.isQuestionAudioCompleted,_that.selectedItem,_that.isCorrect,_that.isAnswered,_that.isAudioPlaying);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ChooseCorrectLessonContent? lessonContent,  Item? currentQuestion,  bool isQuestionAudioPlaying,  bool isQuestionAudioCompleted,  Item? selectedItem,  bool isCorrect,  bool isAnswered,  bool isAudioPlaying)?  $default,) {final _that = this;
switch (_that) {
case _ChooseCorrectLessonContentState() when $default != null:
return $default(_that.lessonContent,_that.currentQuestion,_that.isQuestionAudioPlaying,_that.isQuestionAudioCompleted,_that.selectedItem,_that.isCorrect,_that.isAnswered,_that.isAudioPlaying);case _:
  return null;
...
class _ChooseCorrectLessonContentState implements ChooseCorrectLessonContentState {
  const _ChooseCorrectLessonContentState({this.lessonContent, this.currentQuestion, this.isQuestionAudioPlaying = false, this.isQuestionAudioCompleted = false, this.selectedItem, this.isCorrect = false, this.isAnswered = false, this.isAudioPlaying = false});
...
/// Create a copy of ChooseCorrectLessonContentState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? lessonContent = freezed,Object? currentQuestion = freezed,Object? isQuestionAudioPlaying = null,Object? isQuestionAudioCompleted = null,Object? selectedItem = freezed,Object? isCorrect = null,Object? isAnswered = null,Object? isAudioPlaying = null,}) {
