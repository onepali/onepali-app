...
TapToFillLessonContent _$TapToFillLessonContentFromJson(
  ...
  audioBeforeOptions: json['audio_before_options'] as String?,
  instruction: json['instruction'] as String?,
  preBgImageMb: json['pre_bg_image_mb'] as String?,
  preBgImageTb: json['pre_bg_image_tb'] as String?,
  bgImage: json['bg_image'] as String?,
  bgImageTb: json['bg_image_tb'] as String?,
  options:
...
Map<String, dynamic> _$TapToFillLessonContentToJson(
  ...
  'index': instance.index,
  'type': instance.type,
  'audio_before_options': instance.audioBeforeOptions,
  'instruction': instance.instruction,
  'pre_bg_image_mb': instance.preBgImageMb,
  'pre_bg_image_tb': instance.preBgImageTb,
  'bg_image': instance.bgImage,
  'bg_image_tb': instance.bgImageTb,
