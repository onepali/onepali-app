...
class TeaMakingLessonContent implements LessonContent {
  const TeaMakingLessonContent({required this.id, required this.index, this.type = 'tea_making', required this.audioInstruction, required this.teapotVapour, required this.stoveImage, required this.abaPaniUmalaSound, required this.teaReadySound, required this.dragIndicator, required this.hunchaButton, required this.hunchaButtonAudio, required this.checkIcon, @JsonKey(name: 'leopard_taking_tea_tb', readValue: _readLeopardTakingTeaTb) required this.leopardTakingTeaTb, @JsonKey(name: 'leopard_taking_tea_mb', readValue: _readLeopardTakingTeaMb) required this.leopardTakingTeaMb, final  List<Item> ingredients = const []}): _ingredients = ingredients;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,index,type,audioInstruction,teapotVapour,stoveImage,abaPaniUmalaSound,teaReadySound,dragIndicator,hunchaButton,hunchaButtonAudio,checkIcon,leopardTakingTeaTb,leopardTakingTeaMb,const DeepCollectionEquality().hash(_ingredients));

@override
String toString() {
  return 'LessonContent.teaMaking(id: $id, index: $index, type: $type, audioInstruction: $audioInstruction, teapotVapour: $teapotVapour, stoveImage: $stoveImage, abaPaniUmalaSound: $abaPaniUmalaSound, teaReadySound: $teaReadySound, dragIndicator: $dragIndicator, hunchaButton: $hunchaButton, hunchaButtonAudio: $hunchaButtonAudio, checkIcon: $checkIcon, leopardTakingTeaTb: $leopardTakingTeaTb, leopardTakingTeaMb: $leopardTakingTeaMb, ingredients: $ingredients)';
}
