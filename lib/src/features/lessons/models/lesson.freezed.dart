...
return teaMaking(_that.id,_that.index,_that.type,_that.audioInstruction,_that.teapotVapour,_that.stoveImage,_that.abaPaniUmalaSound,_that.teaReadySound,_that.bearTakingTeaTb,_that.bearTakingTeaMb,_that.ingredients);case BallSlideLessonContent() when ballSlide != null:
...
return tapToFill(_that.id,_that.index,_that.type,_that.instruction,_that.audioBeforeOptions,_that.preBgImageMb,_that.preBgImageTb,_that.bgImage,_that.bgImageTb,_that.options);case OptionSelectionLessonContent() when optionSelection != null:
...
return teaMaking(_that.id,_that.index,_that.type,_that.audioInstruction,_that.teapotVapour,_that.stoveImage,_that.abaPaniUmalaSound,_that.teaReadySound,_that.bearTakingTeaTb,_that.bearTakingTeaMb,_that.ingredients);case BallSlideLessonContent():
...
return tapToFill(_that.id,_that.index,_that.type,_that.instruction,_that.audioBeforeOptions,_that.preBgImageMb,_that.preBgImageTb,_that.bgImage,_that.bgImageTb,_that.options);case OptionSelectionLessonContent():
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TeaMakingLessonContent&&(identical(other.id, id) || other.id == id)&&(identical(other.index, index) || other.index == index)&&(identical(other.type, type) || other.type == type)&&(identical(other.audioInstruction, audioInstruction) || other.audioInstruction == audioInstruction)&&(identical(other.teapotVapour, teapotVapour) || other.teapotVapour == teapotVapour)&&(identical(other.stoveImage, stoveImage) || other.stoveImage == stoveImage)&&(identical(other.abaPaniUmalaSound, abaPaniUmalaSound) || other.abaPaniUmalaSound == abaPaniUmalaSound)&&(identical(other.teaReadySound, teaReadySound) || other.teaReadySound == teaReadySound)&&(identical(other.bearTakingTeaTb, bearTakingTeaTb) || other.bearTakingTeaTb == bearTakingTeaTb)&&(identical(other.bearTakingTeaMb, bearTakingTeaMb) || other.bearTakingTeaMb == bearTakingTeaMb)&&const DeepCollectionEquality().equals(other._ingredients, _ingredients));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,index,type,audioInstruction,teapotVapour,stoveImage,abaPaniUmalaSound,teaReadySound,bearTakingTeaTb,bearTakingTeaMb,const DeepCollectionEquality().hash(_ingredients));

@override
String toString() {
  return 'LessonContent.teaMaking(id: $id, index: $index, type: $type, audioInstruction: $audioInstruction, teapotVapour: $teapotVapour, stoveImage: $stoveImage, abaPaniUmalaSound: $abaPaniUmalaSound, teaReadySound: $teaReadySound, bearTakingTeaTb: $bearTakingTeaTb, bearTakingTeaMb: $bearTakingTeaMb, ingredients: $ingredients)';
}
...
as String,bearTakingTeaTb: null == bearTakingTeaTb ? _self.bearTakingTeaTb : bearTakingTeaTb // ignore: cast_nullable_to_non_nullable
as String,bearTakingTeaMb: null == bearTakingTeaMb ? _self.bearTakingTeaMb : bearTakingTeaMb // ignore: cast_nullable_to_non_nullable
...
class TapToFillLessonContent implements LessonContent {
  const TapToFillLessonContent({required this.id, required this.index, this.type = 'tap_to_fill', this.instruction, this.audioBeforeOptions, this.preBgImageMb, this.preBgImageTb, this.bgImage, this.bgImageTb, final  List<Option> options = const []}): _options = options;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,index,type,instruction,audioBeforeOptions,preBgImageMb,preBgImageTb,bgImage,bgImageTb,const DeepCollectionEquality().hash(_options));

@override
String toString() {
  return 'LessonContent.tapToFill(id: $id, index: $index, type: $type, instruction: $instruction, audioBeforeOptions: $audioBeforeOptions, preBgImageMb: $preBgImageMb, preBgImageTb: $preBgImageTb, bgImage: $bgImage, bgImageTb: $bgImageTb, options: $options)';
}
...
@override @useResult
$Res call({
 String id, int index, String type, String? instruction, String? audioBeforeOptions, String? preBgImageMb, String? preBgImageTb, String? bgImage, String? bgImageTb, List<Option> options
});
...
/// Create a copy of LessonContent
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? index = null,Object? type = null,Object? instruction = freezed,Object? audioBeforeOptions = freezed,Object? preBgImageMb = freezed,Object? preBgImageTb = freezed,Object? bgImage = freezed,Object? bgImageTb = freezed,Object? options = null,}) {
