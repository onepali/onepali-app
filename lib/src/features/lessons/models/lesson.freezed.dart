...
return teaMaking(_that.id,_that.index,_that.type,_that.audioInstruction,_that.teapotVapour,_that.stoveImage,_that.abaPaniUmalaSound,_that.teaReadySound,_that.leopardTakingTeaTb,_that.leopardTakingTeaMb,_that.ingredients);case BallSlideLessonContent() when ballSlide != null:
...
return teaMaking(_that.id,_that.index,_that.type,_that.audioInstruction,_that.teapotVapour,_that.stoveImage,_that.abaPaniUmalaSound,_that.teaReadySound,_that.leopardTakingTeaTb,_that.leopardTakingTeaMb,_that.ingredients);case BallSlideLessonContent():
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,index,type,audioInstruction,teapotVapour,stoveImage,abaPaniUmalaSound,teaReadySound,leopardTakingTeaTb,leopardTakingTeaMb,const DeepCollectionEquality().hash(_ingredients));

@override
String toString() {
  return 'LessonContent.teaMaking(id: $id, index: $index, type: $type, audioInstruction: $audioInstruction, teapotVapour: $teapotVapour, stoveImage: $stoveImage, abaPaniUmalaSound: $abaPaniUmalaSound, teaReadySound: $teaReadySound, leopardTakingTeaTb: $leopardTakingTeaTb, leopardTakingTeaMb: $leopardTakingTeaMb, ingredients: $ingredients)';
}
