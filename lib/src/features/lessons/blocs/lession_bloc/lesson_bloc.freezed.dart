...
@override
int get hashCode => Object.hash(runtimeType,lessonId,lessonDetails,errorMessage,currentIndex,currentContent,itemQuestioned,userSelectedItem,isAnswerCorrect,const DeepCollectionEquality().hash(tapToRevealItems),selectedTapToRevealItem,const DeepCollectionEquality().hash(completedTapToRevealItems),isTapToRevealCompleted);

@override
String toString() {
  return 'LessonState(lessonId: $lessonId, lessonDetails: $lessonDetails, errorMessage: $errorMessage, currentIndex: $currentIndex, currentContent: $currentContent, itemQuestioned: $itemQuestioned, userSelectedItem: $userSelectedItem, isAnswerCorrect: $isAnswerCorrect, tapToRevealItems: $tapToRevealItems, selectedTapToRevealItem: $selectedTapToRevealItem, completedTapToRevealItems: $completedTapToRevealItems, isTapToRevealCompleted: $isTapToRevealCompleted)';
}
...
@useResult
$Res call({
 String? lessonId, LessonDetail? lessonDetails, String? errorMessage, int currentIndex, LessonContent? currentContent, Item? itemQuestioned, Item? userSelectedItem, bool? isAnswerCorrect, List<Item>? tapToRevealItems, Item? selectedTapToRevealItem, List<Item> completedTapToRevealItems, bool isTapToRevealCompleted
});
...
/// Create a copy of LessonState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? lessonId = freezed,Object? lessonDetails = freezed,Object? errorMessage = freezed,Object? currentIndex = null,Object? currentContent = freezed,Object? itemQuestioned = freezed,Object? userSelectedItem = freezed,Object? isAnswerCorrect = freezed,Object? tapToRevealItems = freezed,Object? selectedTapToRevealItem = freezed,Object? completedTapToRevealItems = null,Object? isTapToRevealCompleted = null,}) {
...
as List<Item>,isTapToRevealCompleted: null == isTapToRevealCompleted ? _self.isTapToRevealCompleted : isTapToRevealCompleted // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of LessonState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? lessonId,  LessonDetail? lessonDetails,  String? errorMessage,  int currentIndex,  LessonContent? currentContent,  Item? itemQuestioned,  Item? userSelectedItem,  bool? isAnswerCorrect,  List<Item>? tapToRevealItems,  Item? selectedTapToRevealItem,  List<Item> completedTapToRevealItems,  bool isTapToRevealCompleted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LessonState() when $default != null:
return $default(_that.lessonId,_that.lessonDetails,_that.errorMessage,_that.currentIndex,_that.currentContent,_that.itemQuestioned,_that.userSelectedItem,_that.isAnswerCorrect,_that.tapToRevealItems,_that.selectedTapToRevealItem,_that.completedTapToRevealItems,_that.isTapToRevealCompleted);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? lessonId,  LessonDetail? lessonDetails,  String? errorMessage,  int currentIndex,  LessonContent? currentContent,  Item? itemQuestioned,  Item? userSelectedItem,  bool? isAnswerCorrect,  List<Item>? tapToRevealItems,  Item? selectedTapToRevealItem,  List<Item> completedTapToRevealItems,  bool isTapToRevealCompleted)  $default,) {final _that = this;
switch (_that) {
case _LessonState():
return $default(_that.lessonId,_that.lessonDetails,_that.errorMessage,_that.currentIndex,_that.currentContent,_that.itemQuestioned,_that.userSelectedItem,_that.isAnswerCorrect,_that.tapToRevealItems,_that.selectedTapToRevealItem,_that.completedTapToRevealItems,_that.isTapToRevealCompleted);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? lessonId,  LessonDetail? lessonDetails,  String? errorMessage,  int currentIndex,  LessonContent? currentContent,  Item? itemQuestioned,  Item? userSelectedItem,  bool? isAnswerCorrect,  List<Item>? tapToRevealItems,  Item? selectedTapToRevealItem,  List<Item> completedTapToRevealItems,  bool isTapToRevealCompleted)?  $default,) {final _that = this;
switch (_that) {
case _LessonState() when $default != null:
return $default(_that.lessonId,_that.lessonDetails,_that.errorMessage,_that.currentIndex,_that.currentContent,_that.itemQuestioned,_that.userSelectedItem,_that.isAnswerCorrect,_that.tapToRevealItems,_that.selectedTapToRevealItem,_that.completedTapToRevealItems,_that.isTapToRevealCompleted);case _:
  return null;
...
@override
int get hashCode => Object.hash(runtimeType,lessonId,lessonDetails,errorMessage,currentIndex,currentContent,itemQuestioned,userSelectedItem,isAnswerCorrect,const DeepCollectionEquality().hash(_tapToRevealItems),selectedTapToRevealItem,const DeepCollectionEquality().hash(_completedTapToRevealItems),isTapToRevealCompleted);
...
/// Create a copy of LessonState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? lessonId = freezed,Object? lessonDetails = freezed,Object? errorMessage = freezed,Object? currentIndex = null,Object? currentContent = freezed,Object? itemQuestioned = freezed,Object? userSelectedItem = freezed,Object? isAnswerCorrect = freezed,Object? tapToRevealItems = freezed,Object? selectedTapToRevealItem = freezed,Object? completedTapToRevealItems = null,Object? isTapToRevealCompleted = null,}) {
