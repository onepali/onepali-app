...
mixin _$LessonState {
 ...
 String? get lessonId; LessonDetail? get lessonDetails; int get currentIndex; LessonContent? get currentContent; bool? get changingContent;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LessonState&&(identical(other.lessonId, lessonId) || other.lessonId == lessonId)&&(identical(other.lessonDetails, lessonDetails) || other.lessonDetails == lessonDetails)&&(identical(other.currentIndex, currentIndex) || other.currentIndex == currentIndex)&&(identical(other.currentContent, currentContent) || other.currentContent == currentContent)&&(identical(other.changingContent, changingContent) || other.changingContent == changingContent));
}


@override
int get hashCode => Object.hash(runtimeType,lessonId,lessonDetails,currentIndex,currentContent,changingContent);

@override
String toString() {
  return 'LessonState(lessonId: $lessonId, lessonDetails: $lessonDetails, currentIndex: $currentIndex, currentContent: $currentContent, changingContent: $changingContent)';
}
...
@useResult
$Res call({
 String? lessonId, LessonDetail? lessonDetails, int currentIndex, LessonContent? currentContent, bool? changingContent
});
...
/// Create a copy of LessonState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? lessonId = freezed,Object? lessonDetails = freezed,Object? currentIndex = null,Object? currentContent = freezed,Object? changingContent = freezed,}) {
...
as LessonContent?,changingContent: freezed == changingContent ? _self.changingContent : changingContent // ignore: cast_nullable_to_non_nullable
as bool?,
  ));
}
/// Create a copy of LessonState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? lessonId,  LessonDetail? lessonDetails,  int currentIndex,  LessonContent? currentContent,  bool? changingContent)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LessonState() when $default != null:
return $default(_that.lessonId,_that.lessonDetails,_that.currentIndex,_that.currentContent,_that.changingContent);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? lessonId,  LessonDetail? lessonDetails,  int currentIndex,  LessonContent? currentContent,  bool? changingContent)  $default,) {final _that = this;
switch (_that) {
case _LessonState():
return $default(_that.lessonId,_that.lessonDetails,_that.currentIndex,_that.currentContent,_that.changingContent);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? lessonId,  LessonDetail? lessonDetails,  int currentIndex,  LessonContent? currentContent,  bool? changingContent)?  $default,) {final _that = this;
switch (_that) {
case _LessonState() when $default != null:
return $default(_that.lessonId,_that.lessonDetails,_that.currentIndex,_that.currentContent,_that.changingContent);case _:
  return null;
...
class _LessonState implements LessonState {
  const _LessonState({this.lessonId, this.lessonDetails, this.currentIndex = 0, this.currentContent, this.changingContent});
...
@override final  bool? changingContent;
...
/// Create a copy of LessonState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? lessonId = freezed,Object? lessonDetails = freezed,Object? currentIndex = null,Object? currentContent = freezed,Object? changingContent = freezed,}) {
