...
class DragToMatchEvent with _$DragToMatchEvent {
  const factory DragToMatchEvent.initialize({required List<Item> items}) =
      _Initialize;
  ...
  const factory DragToMatchEvent.startDrag({required String itemId}) =
      _StartDrag;
  ...
  const factory DragToMatchEvent.playItemAudio({required String itemId}) =
      _PlayItemAudio;

  const factory DragToMatchEvent.audioPlaybackComplete() =
      _AudioPlaybackComplete;
