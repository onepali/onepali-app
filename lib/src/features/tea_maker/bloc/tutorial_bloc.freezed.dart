...
@override
int get hashCode => Object.hash(runtimeType,showLoading,index,draggedIndex,const DeepCollectionEquality().hash(ingredients),showLeopardWithTea,showHunchButton,showDragIndicator,draggedItemPath,droppedItem,stoveImage,leopardTakingTeaTb,leopardTakingTeaMb,teaReady);

@override
String toString() {
  return 'TutorialState(showLoading: $showLoading, index: $index, draggedIndex: $draggedIndex, ingredients: $ingredients, showLeopardWithTea: $showLeopardWithTea, showHunchButton: $showHunchButton, showDragIndicator: $showDragIndicator, draggedItemPath: $draggedItemPath, droppedItem: $droppedItem, stoveImage: $stoveImage, leopardTakingTeaTb: $leopardTakingTeaTb, leopardTakingTeaMb: $leopardTakingTeaMb, teaReady: $teaReady)';
}
...
@useResult
$Res call({
 bool showLoading, int index, int draggedIndex, List<String> ingredients, bool showLeopardWithTea, bool showHunchButton, bool showDragIndicator, String? draggedItemPath, String? droppedItem, String? stoveImage, String? leopardTakingTeaTb, String? leopardTakingTeaMb, bool teaReady
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool showLoading,  int index,  int draggedIndex,  List<String> ingredients,  bool showLeopardWithTea,  bool showHunchButton,  bool showDragIndicator,  String? draggedItemPath,  String? droppedItem,  String? stoveImage,  String? leopardTakingTeaTb,  String? leopardTakingTeaMb,  bool teaReady)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TutorialState() when $default != null:
return $default(_that.showLoading,_that.index,_that.draggedIndex,_that.ingredients,_that.showLeopardWithTea,_that.showHunchButton,_that.showDragIndicator,_that.draggedItemPath,_that.droppedItem,_that.stoveImage,_that.leopardTakingTeaTb,_that.leopardTakingTeaMb,_that.teaReady);case _:
  return orElse();
...
@override
int get hashCode => Object.hash(runtimeType,showLoading,index,draggedIndex,const DeepCollectionEquality().hash(_ingredients),showLeopardWithTea,showHunchButton,showDragIndicator,draggedItemPath,droppedItem,stoveImage,leopardTakingTeaTb,leopardTakingTeaMb,teaReady);
