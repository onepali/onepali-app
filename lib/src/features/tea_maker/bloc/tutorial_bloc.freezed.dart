...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  started,TResult Function()?  hunchaButtonPressed,TResult Function( int index)?  onDragAccept,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _HunchaButtonPressed() when hunchaButtonPressed != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  started,required TResult Function()  hunchaButtonPressed,required TResult Function( int index)  onDragAccept,}) {final _that = this;
switch (_that) {
case _Started():
return started();case _HunchaButtonPressed():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  started,TResult? Function()?  hunchaButtonPressed,TResult? Function( int index)?  onDragAccept,}) {final _that = this;
switch (_that) {
case _Started() when started != null:
return started();case _HunchaButtonPressed() when hunchaButtonPressed != null:
return hunchaButtonPressed();case _OnDragAccept() when onDragAccept != null:
...
mixin _$TutorialState {
 ...
 int get index; int get draggedIndex; List<String> get ingredients; bool get showBearWithTea; bool get showHunchButton; bool get showDragIndicator; String? get draggedItemPath; String? get droppedItem; bool get teaReady;
...
@override
int get hashCode => Object.hash(runtimeType,index,draggedIndex,const DeepCollectionEquality().hash(ingredients),showBearWithTea,showHunchButton,showDragIndicator,draggedItemPath,droppedItem,teaReady);

@override
String toString() {
  return 'TutorialState(index: $index, draggedIndex: $draggedIndex, ingredients: $ingredients, showBearWithTea: $showBearWithTea, showHunchButton: $showHunchButton, showDragIndicator: $showDragIndicator, draggedItemPath: $draggedItemPath, droppedItem: $droppedItem, teaReady: $teaReady)';
}
...
@useResult
$Res call({
 int index, int draggedIndex, List<String> ingredients, bool showBearWithTea, bool showHunchButton, bool showDragIndicator, String? draggedItemPath, String? droppedItem, bool teaReady
});
...
/// Create a copy of TutorialState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? index = null,Object? draggedIndex = null,Object? ingredients = null,Object? showBearWithTea = null,Object? showHunchButton = null,Object? showDragIndicator = null,Object? draggedItemPath = freezed,Object? droppedItem = freezed,Object? teaReady = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int index,  int draggedIndex,  List<String> ingredients,  bool showBearWithTea,  bool showHunchButton,  bool showDragIndicator,  String? draggedItemPath,  String? droppedItem,  bool teaReady)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TutorialState() when $default != null:
return $default(_that.index,_that.draggedIndex,_that.ingredients,_that.showBearWithTea,_that.showHunchButton,_that.showDragIndicator,_that.draggedItemPath,_that.droppedItem,_that.teaReady);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int index,  int draggedIndex,  List<String> ingredients,  bool showBearWithTea,  bool showHunchButton,  bool showDragIndicator,  String? draggedItemPath,  String? droppedItem,  bool teaReady)  $default,) {final _that = this;
switch (_that) {
case _TutorialState():
return $default(_that.index,_that.draggedIndex,_that.ingredients,_that.showBearWithTea,_that.showHunchButton,_that.showDragIndicator,_that.draggedItemPath,_that.droppedItem,_that.teaReady);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int index,  int draggedIndex,  List<String> ingredients,  bool showBearWithTea,  bool showHunchButton,  bool showDragIndicator,  String? draggedItemPath,  String? droppedItem,  bool teaReady)?  $default,) {final _that = this;
switch (_that) {
case _TutorialState() when $default != null:
return $default(_that.index,_that.draggedIndex,_that.ingredients,_that.showBearWithTea,_that.showHunchButton,_that.showDragIndicator,_that.draggedItemPath,_that.droppedItem,_that.teaReady);case _:
  return null;
...
class _TutorialState implements TutorialState {
  const _TutorialState({this.index = -1, this.draggedIndex = 0, final  List<String> ingredients = const [], this.showBearWithTea = false, this.showHunchButton = false, this.showDragIndicator = false, this.draggedItemPath, this.droppedItem, this.teaReady = false}): _ingredients = ingredients;
...
@override
int get hashCode => Object.hash(runtimeType,index,draggedIndex,const DeepCollectionEquality().hash(_ingredients),showBearWithTea,showHunchButton,showDragIndicator,draggedItemPath,droppedItem,teaReady);
...
/// Create a copy of TutorialState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? index = null,Object? draggedIndex = null,Object? ingredients = null,Object? showBearWithTea = null,Object? showHunchButton = null,Object? showDragIndicator = null,Object? draggedItemPath = freezed,Object? droppedItem = freezed,Object? teaReady = null,}) {
