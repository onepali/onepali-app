...
class _NormalContentState extends State<NormalContent>
    with AutoAdvanceMixin<NormalContent> {
  ...
  @override
  void didUpdateWidget(covariant NormalContent oldWidget) {
  ...
  void _scheduleAutoAdvanceIfReady(
    BuildContext context,
    StoryProvider storyProvider,
  ) {
    if (!widget.playAudio ||
        widget.content.audio.every((audio) => audio.isEmpty) ||
        !storyProvider.isAudioCompleted) {
      return;
    }
        ...
        children: [
          Consumer<StoryProvider>(
            builder: (context, storyProvider, _) {
              _scheduleAutoAdvanceIfReady(context, storyProvider);
