...
class CustomAvatarGlow extends StatefulWidget {
  /// Creates an [CustomAvatarGlow] widget.
  const CustomAvatarGlow({
    super.key,
    required this.child,
    this.glowCount = 2,
    this.glowColor = AppColors.kWhite,
...
class _CustomAvatarGlowState extends State<CustomAvatarGlow>
    with SingleTickerProviderStateMixin<CustomAvatarGlow> {
  ...
  @override
  void didUpdateWidget(covariant CustomAvatarGlow oldWidget) {
